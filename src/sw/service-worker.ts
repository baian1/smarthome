interface NewServiceWorkerGlobalScope extends ServiceWorkerGlobalScope {
  __precacheManifest: { url: string; version?: string }[]
}
declare var self: NewServiceWorkerGlobalScope
export {}
...
function updateCache(url: string | Request) {
