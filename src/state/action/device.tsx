...
export const changeDeviceSensor = (
  devicesID: string,
  sensor: sensorType,
...
//async dispatch
export const initDevicelist = (): ThunkAction<
  Promise<boolean>,
  AppStateInterface,
  null,
  Action<string>
...
export const deleteDevice = (
  deviceID: string
): ThunkAction<Promise<boolean>, AppStateInterface, null, Action<string>> => {
  return async (dispatch): Promise<boolean> => {
...
export const saveDeviceInformation = (
